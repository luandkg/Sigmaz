        ...
        for (Pacote PacoteC : lsPacotes) {
            ...
            if (PacoteC.getPacotes().size() == 0 && PacoteC.getListas().size() == 0
                ...
                for (Identificador IdentificadorC : PacoteC.getIdentificadores()) {
                    ...
                    eIdentificadores += " ID " + Codifica(IdentificadorC.getNome()) + " = " + "\"" + Codifica(IdentificadorC.getValor()) + "\"";

                }


                ITextoC.AdicionarLinha(ePrefixo + "PACOTE " + Codifica(PacoteC.getNome()) + " { " + eIdentificadores + " } ");
