...
import Sigmaz.S06_Montador.ArquivadorUtils;
import Sigmaz.S06_Montador.OLM;
import Sigmaz.S06_Montador.OLMCabecalho;
    ...
    public void dump(String eArquivo) {
        ...
        if (mEnc) {
            ...
            try {
                ...
                System.out.println("\t - OLM Sigmaz : " + mOLM.getSetorSigmaz() + " :: " + mOLM.getSigmaz_Fim() + " -->> " + mOLM.getSigmaz_Tamanho());
                System.out.println("\t - OLM Codigo : " + mOLM.getSetorCodigo() + " :: " + mOLM.getCodigo_Tamanho());
                System.out.println("\t - OLM Assinatura : " + mOLM.getAssinatura_Inicio() + " :: " + mOLM.getAssinatura_Tamanho());
