...
import Sigmaz.S01_PreProcessamento.Enfileirador;
...
public class PreProcessamento {
    ...
    public void init(ArrayList<String> eArquivos, AST AST_Raiz) {
        ...
        ArrayList<String> mProcessados = new ArrayList<String>();
        ...
        while (mFila.estaExecutando()) {
            ...
            if (mLocalRequisicao != null) {
                ...
                Etapa mEtapa = new Etapa(mEtapaID, mLocalRequisicao);
                mEtapaID += 1;
                mEtapas.add(mEtapa);

                mRequisitados.add(mLocalRequisicao);
                mProcessados.add(mLocalRequisicao);
                ...
                if (arq.exists()) {
                    ...
                    for (Importacao a : mCompilerUnit.getFila()) {
                        ...
                        if (mProcessados.contains(a.getImportando())) {
