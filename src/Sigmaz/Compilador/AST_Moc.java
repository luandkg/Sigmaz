...
public class AST_Moc {

    private Compiler mCompiler;

    public AST_Moc(Compiler eCompiler) {
        mCompiler = eCompiler;
    }
    ...
    public void init(AST ASTPai) {
        ...
        if (TokenC.getTipo() == TokenTipo.ID) {
            ...
            if (TokenP3.getTipo() == TokenTipo.PONTOVIRGULA) {
                ...
                mCompiler.errarCompilacao("O valor de uma CONSTANTE e obrigatorio !", TokenC.getInicio());
                return;
