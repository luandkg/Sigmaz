...
public class AST_Define {

    private Compiler mCompiler;

    public AST_Define(Compiler eCompiler) {
        mCompiler = eCompiler;
    }
    ...
    public void init(AST ASTPai,String Visibilidade ) {
        ...
        if (TokenC.getTipo() == TokenTipo.ID) {
            ...
            if (TokenP3.getTipo() == TokenTipo.PONTOVIRGULA) {
                ...
                mCompiler.errarCompilacao("Era esperado o valor da DEFINICAO !", TokenC.getInicio());

            }


        } else {
            mCompiler.errarCompilacao("Era esperado o nome da DEFINICAO !", TokenC.getInicio());
        }
